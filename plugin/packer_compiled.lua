...
_G.packer_plugins = {
  ...
  catppuccin = {
    loaded = true,
    path = "/Users/abhayfaldu/.local/share/nvim/site/pack/packer/start/catppuccin",
  ...
  ["vim-nightfly-colors"] = {
    loaded = true,
    path = "/Users/abhayfaldu/.local/share/nvim/site/pack/packer/start/vim-nightfly-colors",
